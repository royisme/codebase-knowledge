...
import {
  type ChatUser,
  type Convo,
} from '@/components/ragApp/chat/data/chat-types'
// Fake Data
import { conversations } from '@/components/ragApp/chat/data/convo.json'
import { NewChat } from '@/components/ragApp/chat/new-chat'
