...
const audits: RbacAuditLog[] = [
  {
    ...
    target: 'role-admin / knowledge_sources',
    status: 'success',
    timestamp: new Date('2025-01-16T08:12:00Z').toISOString() as RbacAuditLog['timestamp'],
    details: '为管理员授予 manage 权限',
  },
  {
    id: 'audit-2' as Identifier,
    actor: 'admin@example.com',
    action: 'update_policy',
    target: 'role-viewer / knowledge_sources',
    status: 'success',
    timestamp: new Date('2025-01-17T02:45:00Z').toISOString() as RbacAuditLog['timestamp'],
    details: '仅保留 read 权限',
  },
]
